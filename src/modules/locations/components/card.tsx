...
const Card = (props: Localization) => {
  return (
    <div
      className="relative flex flex-col py-4 px-3 h-56 rounded-xl shadow-md bg-teal-100 hover:bg-teal-200 dark:bg-gray-scale dark:hover:bg-teal-900 transition-all"
    >
...
<p className="text-lg hover:text-secondary dark:hover:text-primary transition-all"><strong className='mr-2'>Tipo:</strong>{props.type}</p>
        <p className="text-xl font-light text-gray-500 dark:text-gray-300"><b className='mr-2'>Dimensão:</b>{props.dimension}</p>
      </div>
      <Link
